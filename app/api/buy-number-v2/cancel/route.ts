...
export async function POST(req: Request) {
  try {
    ...
    console.log("V2 SMSPool manual cancel response:", smsPoolData);
    ...
    console.error("V2 cancel error:", error);
    ...
    if (message === "INVALID_WALLET_BALANCE") {
      return NextResponse.json(
        {
          success: false,
          message: "Your wallet balance is invalid.",
        },
        { status: 500 }
      );
    }
